...
const { getAllPartSalesData, editPartSalesDataAdmin, getSearchedPartSaleData, getSinglePartSalesData, getPartSalesReportNumber } = require(path.join(__dirname, '../apisController/partSalesDataController'));
